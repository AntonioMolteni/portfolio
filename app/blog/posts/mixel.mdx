...
<a href="https://github.com/AntonioMolteni/Pixel-Prism-Project" target="_blank">
  Unity Version
</a>
...
I also had some feedback on the scoring algorithms that compare the goal color and the player's current color. Colors that appear to be the same were not similar enough according to the algorithm. I upgraded this code to use the CIE94 color comparison metric which you can read more about <a href="https://en.wikipedia.org/wiki/Color_difference#CIE94" target="_blank">here</a>. This new algorithm still had the same problem (albeit to a lesser extent). I am currently working on a new algorithm to solve this problem but it requires a lot of calibration to do so. Below is the CIE94 Algorithm implemented:
...
<a href="https://github.com/AntonioMolteni/PaletteMatchReact" target="_blank">
  ReactJS and ColyseusJS Version
</a>
...
This is the current version of the game that has been published at <a href="https://playmixel.com" target="_blank">playmixel.com</a> and on the <a href="https://apps.apple.com/us/app/play-mixel/id6737012541" target="_blank">Apple App Store</a>

If you have any bugs, suggestions, or want to contribute, please let me know at <a href="mailto:support@playmixel.com">support@playmixel.com</a>.
